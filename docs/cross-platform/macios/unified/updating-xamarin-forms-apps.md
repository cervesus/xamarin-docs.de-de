...
description: Dieses Dokument beschreibt die Schritte, die zum Aktualisieren einer Xamarin.Forms-app aus der klassischen-API an die API Unified befolgt werden müssen.
ms.prod: xamarin
