...
description: Dieses Dokument beschreibt die Schritte, die ausgeführt werden müssen, um eine app Xamarin.Mac aus der klassischen-API an die API Unified aktualisieren.
ms.prod: xamarin
