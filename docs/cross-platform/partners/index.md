...
|[Azuris CloudSystem](http://www.azuris.us)|Curitiba, Parana, Brasilien; Orlando, Florida|Azuris ist ein Unternehmen für Softwareentwicklung mit starken Erfahrung in der Appentwicklung|
...
|[Mooseworks Software](http://mooseworkssoftware.com/)|Dublin, Notification Hub |Mooseworks Software wurde 2003 gestartet. Wir spezielle in mobilen Markt, bevor Sie Mobile wurde "cool". In dieser Zeit haben wir Steuerelemente an Entwickler verkauft, die Anwendungen mit Hunderten oder Tausenden von Endbenutzern erstellt hat. W|
...
|[XAM Consulting](http://www.xam-consulting.com/)|Australien Breite|XAM erstellen Sie professionelle Anwendungen. Team von Spezialisten mehr als 20 in Xamarin und serverlosen Architekturen.|
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[Apcurium](http://www.apcurium.com)|Montreal (Kanada)|Apcurium Entwicklung mobile Lösungen, die heute auf mobilen Geräten, Plattformen und Technologien mit bestimmten unternehmenserwartungen Strategien und Benutzer zu verbinden.|
|[BSI-Labs](https://bsilabs.ca/)|Toronto, Kanada|BSI Labs ist eine umfassende Beratung spezialisiert ist, die in mobile Strategie, UX/UI-Entwurf, Entwicklung mobiler Apps und Systemintegration.|
|[Clearbridge Mobile](https://clearbridgemobile.com/)|Toronto, Kanada|Clearbridge Mobile ist ein preisgekrönten full-Stack mobilen app-Entwicklung ein Unternehmen, das zur benutzerorientierten Produkt Entwurf und Entwicklung bereitstellt|
|[Kognitive X Solutions Inc.](http://cognitivex.com)|Moncton (Kanada)|Wir erstellen von Web- und mobilen Umgebungen |
|[Cortex-Medien](http://cortex.bz)|Quebec, Kanada|Cortex-Medien entwirft mobile Plattformen, die die tatsächlichen und das virtuelle verbinden Unternehmen und Personen|
|[Formatec](http://mobile.formatec.ca)|Halifax, Neuschottland, Kanada|Formatec ist ein Privatunternehmen Kanadische Unternehmen, die spezialisiert erstellen und Testen von Anwendungen, die auf mobilen Geräten wie Smartphones und Tablets ausgeführt werden soll.|
...
|[ObjectSharp Corporation](http://www.objectsharp.com)|Toronto, Kanada|Als ersten .NET für Microsoft Consulting Partner in Kanada bieten ObjectSharp eine vollständige Palette von Microsoft benutzerdefinierte Entwicklung, Sie Schulungen und Beratung Dienste für: PC und Tablet, Windows 8 und Windows 7, Phone, Windows Phone, in der Cloud und Azure. Ihre Microsoft-MVPs, leitender Software-Entwicklern und erfahrenen Trainer für hilft Ihnen entwerfen, erstellen und Bereitstellen von Anwendungen besser und schneller.|
...
|[Bluefragments](http://www.bluefragments.com)|Kopenhagen, Dänemark|Bluefragments Appentwicklung spezialisiert und ist ein zertifizierter Microsoft-Partner.|
|[ApS mit Comet.DK (CometPeople)](http://comet.dk)|Kopenhagen, Dänemark|Comet ist Entwicklung, die bietet, die Entwicklung von mobilen Anwendungen mit den neuesten mobilen Plattformen wie iPhone, iPad, Android und Windows Phone|
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[Altran Frankreich](http://www.altran.fr/)|Paris, Frankreich|Altran ist weltweit führend im Bereich Engineering und f & E-Dienste|
|[Arolla](http://www.arolla.fr/)|Paris, Frankreich|Arolla ist eine consulting Firma in die fortschrittlichsten Techniken der Entwicklung von Software spezialisiert hat.|
|[Cellenza](http://www.cellenza.com)|Paris, Frankreich|Cellenza ist eine Beratung für technische Kenntnisse und der Implementierung, die ausschließlich auf Microsoft-Technologie und agile-Methoden|
|[Chloro](http://www.chloro.eu)|Selestat, Frankreich|Chloro spezialisiert sich auf den Entwurf und Entwicklung von benutzerdefinierten mobile Anwendungen, die versuchen, die Sie in der Produktivität und Reaktionsschnelligkeit einen Leistungsgewinn bringen|
|[DevoTeam-Gruppe](http://www.devoteam.com)|Paris, Frankreich|Am Devoteam stellen wir innovativen Technologie, die Beratung für Unternehmen|
|[Exakis](http://www.exakis.com)|Paris, Frankreich|Exakis hilft Unternehmen, innovativen Projekte plant Ihr und Sicherheit von Informationssystemen zu entwickeln. Benutzer mit Fokus, entwickeln sie Lösungen basierend auf der Microsoft-Technologien, die Kombination von Entwurf und innovation|
|[Ideine](http://ideine.fr/en/ideine/)|Roubaix, Frankreich|Source-Entwicklung Spezialist Ideine entwirft und entwickelt benutzerdefinierte, innovative und effiziente mobile Anwendungen.|
|[Infinite Square](http://www.infinitesquare.com)|Paris, Frankreich|Infinite Square Mission ist zu entwerfen und erstellen innovative softwareanwendungen und bessere Qualität im Auftrag ihrer Kunden, großen und kleinen Unternehmen, die beste Beziehung der Vertrauensstellung und ausschlaggebende zusammen.|
|[Isiasoft](http://www.isiasoft.com/)|Paris, Frankreich; Lyon, Frankreich|ISEO stellt breiten Spektrum von Entwicklungs- und Consultacy Softwaredienste bereit.|
|[LA Mobile IT](http://www.la-mobile-it.com)|Grenoble, Frankreich|Nous Sommes Spécialisés Depuis 10 Ans Dans le mobile et Avons des Beziehungen Étroites Avec Nos Partenaires Client et Fournisseurs gießen loben ce Qui touche Kenntnis la Mobilité. Nous n'avons Aucune Exclusivité, Si Vous Désirez Obtenir des Conseils, Nous Présenter Une Lösung Organisationseinheit Encore Devenir Partenaire, Contactez-Nous!|
|[Matelli-Dienste](http://www.matelli.fr/english/)|Paris, Frankreich|Matelli ist ein Informationen Services Unternehmen gegründet 2008 zum Erstellen von benutzerdefinierten Business-Web-Apps und mobile Anwendungen für die Clients.|
|[Mentalen funktioniert](http://www.mentalworks.fr)|Paris, Frankreich|Mentalworks ist eine ungewöhnliche technologische digital-Agentur: beide web-Marketing-e-Agentur Agentur und Beratung Firmen / ESN. Dieser Kenntnisse können sie zum Erstellen von Websites, mobile apps oder benutzerdefinierte Geschäftsanwendungen und wichtige technologische Lösungen zu integrieren.|
|[Orange Anwendungen für Unternehmen](http://www.orange-business.com/en/contact-us)|Paris, Frankreich; Zürich, Schweiz|Orange Business Services ist eine globale Telekommunikationsanbieter und IT-Dienstleistungsunternehmen. Die 20.000 Mitarbeiter unterstützt Unternehmen, lokale Regierungsstellen und Organisationen des öffentlichen Sektors in jeden Aspekt der ihre digitale Transformation. Sie können Unternehmen effizienter zusammenarbeiten, arbeiten effizienter und tauschen Sie sich besser mit Kunden &ndash; verbinden ihre Mitarbeiter, Websites und Computer sicher und zuverlässig.|
|[VORHERIGE SEITE](http://www.pageup.fr)|Dijon, Frankreich||
|[Rayonnance-Technologien](http://rayonnance.fr)|Paris, Frankreich|Der Gruppe "Rayonnance" ist ein führender französische Integrator spezialisiert sich auf mehr als 13 Jahren in der Implementierung von rückverfolgbarkeit und Mobilität der Anwendungen auf Windows-Terminaldienste-Business (Windows Mobile, Windows Phone 8.1, Windows 8), Android, IOS.|
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[27interactive](http://27interactive.com)|Düsseldorf, Deutschland; Universitätsklinikum Hamburg Eppendorf, Deutschland|Angepasste cross Platform Solutions für Smartphones und Tablets mit Android, iOS, Windows und macOS|
|[AIT](http://www.aitgmbh.de)|Stuttgart, Deutschland|AIT ist einer der führende Entwickler und Software-Berater, spezialisiert auf die .NET-Plattform und vieles mehr. Es wurde seit vielen Jahren mit mehreren Award gewinnende Microsoft Gold Partner.|
|[Alles über "Ashley" GmbH](http://www.a-gentur.de)|Ibbenbueren, Deutschland|Informationen über die "Ashley" unterstützt Unternehmen, in den Entwurf und die Optimierung der IT-Lösungen.|
...
|[msg-Systeme ag](https://www.msg.group/travel-logistics/xamarin)|Berlin, Deutschland; Braunschweig, Deutschland; Bretten, Deutschland; Chemnitz, Deutschland; Köln (Köln), Deutschland; Essen, Deutschland; Frankfurt/m, Deutschland Görlitz, Deutschland; Universitätsklinikum Hamburg Eppendorf, Deutschland; Hannover, Deutschland; Ingolstadt, Deutschland; Lingen (Ems), Deutschland; Münster, Deutschland; Nuremberg (Nürnberg), Deutschland; Für den Passauer, Deutschland; Schortens / Wilhelmshaven, Deutschland; St. Georgen, Deutschland; Stuttgart, Deutschland; Walldorf, Deutschland; Basel Schweiz; Wien (Wien), Österreich|msg ist eine unabhängige, internationale Unternehmensgruppe mit mehr als 7.000 Mitarbeitern auf der ganzen Welt, bietet eine ganzheitliche Service Spektrum kreative, strategische consulting und intelligenter, dauerhaften und Value-Added IT-Lösungen für umfangreiches Spektrum an Branchen.|
...
|[Tech Mahindra](https://techmahindra.com)|Bengaluru|Tech Mahindra stellt der vernetzten Welt Angebot innovativer und kundenorientierter IT-Dienste und Lösungen ermöglichen Unternehmen, Partnern und Society, Rise™ dar. Wir sind ein 4.4 Milliarden US-Dollar-Unternehmen mit 117,600 +-Experten in 90 Ländern, über 840 + globale Kunden, einschließlich der Fortune 500-Unternehmen unterstützen.|
|[TechAhead Software Pvt. Ltd.](http://www.techaheadcorp.com)|Princeton, "Nj"; Noida, Indien|Wir sind Mobility-Lösungen erstellen, die Arbeitsplatz digitale Transformation beschleunigen, Produktivität erhöhen, erzwingen von Sicherheit und es Benutzern ermöglichen, überall und auf jederzeit zu arbeiten. Entwickeln Sie mobilitätslösungen Fallback mit ähnlichen Zeichen, für das Enterprise-Modell und geschäftliche Ziele, die perfekt mit Marke Wahrnehmung, Markt Penetrationstests, Dienstintegration und Erwartungen der Kunden nachhaltig.|
...
|[Dataexpert S.r.l.](http://www.dataexpert.it)|Mailand, Italien|Dataexpert ist führend im IT-dienstebereitstellung mit einem hohen Wert erhalten so innovative, dienstorientierte, Ihnen die Integration mit vorhandenen IT-Infrastrukturen, eine schnelle und einfache Implementierung|
|[Beachten Sie die Factory](http://www.factorymind.com)|Trento, Italien|Beachten Sie die Factory ist ein jung und dynamische kooperativen, bestehend aus einem Team von engagierten Entwickler eine Kick für Informatik, Technologien und Innovationen.|
|[Fünfte Ingenium](https://fifthingenium.com/)|Mailand, Italien|FifthIngenium ist ein Italienisch IT-Unternehmen auf Mobile Apps, Cloud-Lösungen und aufkommende Technologien spezialisiert hat|
|[Gaia S.r.l.](http://www.gaia.is.it/en/)|Mailand, Italien|Gaia ist eine Erfahrung Entwurf Unternehmen entwickelt digitale-Ökosysteme für Personen erstellt.|
|[Giuneco s.r.l.](http://www.giuneco.it/)|Florenz (Italien)|Das Unternehmen Ziel ist es, neue Technologien, die (vor allem im Zusammenhang mit der Microsoft-Welt) auszunutzen, um effektive und effiziente Lösungen mit viel Aufmerksamkeit auf die benutzerfreundlichkeit (UX) und verwaltbarkeit zu erstellen.|
|[Lemcube](http://www.lemcube.com)|Paese, Treviso, Italien|Beratungsfirma mit 10 Jahre Erfahrung mit Microsoft .net. Unsere Kunden sind logistische Branchen, Wartung und Mobilität. Wir bieten coaching und Trainieren für den Auftrag.|
|[Mahiz Srl](http://www.mahiz.it/)|Italien|Artisans von Software, Mahiz unterstützt Unternehmen dabei, bessere Produkte erstellen 20 Jahre Erfahrung im Bereich der Informationstechnologie bereitstellen. Ihre Aufgabe besteht darin, die Welt der schlechte Software entfernen, die die Entwicklung von Produkt, Prozesse und Ideen blockiert. |
|[Proge-Software](http://www.progesoftware.com)|ROM, Italien, Mailand, Italien|Wir haben von Projekten mit hoher technologischen Inhalten für große und mittlere Unternehmen, International, sowohl Politiker seit 1985 erstellt wurde. Wir bieten alle Aktivitäten, die für den Entwurf, Entwicklung und Wartung des Unternehmens-IT-Systems|
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[Alset](http://alset.com.mx)|Mexiko-Stadt, Mexiko|ALSET ist ein Unternehmen in Informationstechnologie (IT) mit langjähriger Erfahrung bei der Bereitstellung von Branchen mit Stand der Technik, erweiterte, zuverlässige und stabile Lösungen spezialisiert hat|
|[Gigigo-Gruppe](http://www.gigigo.com)|Mexiko-Stadt, Mexiko; SAN-Paulo, Brasilien; Madrid, Spanien|Während dieser Jahre 2004, gegründet Gigigo einer robusten und zuverlässigen digitale Ally, weiterleiten und die zugehörigen für großer Unternehmen über ihren Weg in Richtung digitale Transformation kann geworden|
|[InfoTacto](http://infotacto.com)|Mexiko-Stadt, Mexiko|Wir sind eine fachübergreifenden Gruppe von IT-Experten mit langjähriger Erfahrung in Risikomanagement, Gesundheit, Sozialversicherungsnummer (Rentenpläne und soziale Vorteil-Schemas), öffentliche Sicherheit, Hotel Sektor, und Computer-Technologien.|
|[Lisyx Technologien SA de CV](http://www.lisyx.com)|Leon, Guanajuato|Lisyx Technologien ist eine consulting Firma, die sich auf Lösungen für Informationstechnologie und Geschäftsprozesse konzentriert. Sie bieten Beratungsdienste geschäftsfähigkeiten und IT-Outsourcing-Dienste und Lösungen, die neue Technologie.|
|[Migesa](http://www.migesa.com.mx/)|Monterrey, Nueva Leon, Mexiko, CDMX, Mexiko-Stadt, Mexiko|Vorhanden Migesa auf dem Markt für mehr als 35 Jahre ist eines der größten Informationen und Kommunikationstechnologien Dienste und Lösungen Integrator. Wir entwickeln und implementieren angepasste Lösungen für die Anforderungen der mittleren und großen Unternehmen.|
|[RAMSCT SC](http://www.ramsct.com )|Mexiko-Stadt|Cada Empresa eine Nivel Mundial Se Encuentra Actualmente Evaluando la Mejor Manera de Utilizar Soluciones Móviles Dentro de "su" Negocio. Nuestra Experiencia En Soluciones Móviles Por Más de 10 Años Nos Permite Ofrecer Soluciones Totalmente Integradas Incluyendo:  |
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[Agile-Technologien](http://www.agiletz.com)|Dubai, Vereinigte Arabische Emirate; Kuwait; Oman; Bahrain; Katar; Kairo, Ägypten|Agile-Technologien ist Enterprise IT Solutions Provider Beratung, Training und Dienste rund um DevOps, Entwicklung und Testen von Diensten bereitstellen.|
|[CodeValue](http://www.codevalue.net)|Herzliya, Israel; Yokne'am Illit, Israel|CodeValue ist ein führender Softwareunternehmen, das Bereitstellen einer-Analysedienst von Softwarediensten, mit denen Kunden ihre Geschäftsaktivitäten Core konzentrieren können|
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[Caesar-Experten](http://www.caesarexperts.nl/)|UTRECHT, Niederlande|Caesar Experten entwirft, builds, implementiert und leistungsstarke innovative ICT-Lösungen verwaltet.|
|[Dalosy](https://dalosy.com)|Hendrik-Ido-Ambacht, Niederlande| Dalosy bietet mobile Lösungen, die die spezifischen Anforderungen und Herausforderungen bei der verschiedenen Unternehmen und Branchen erfüllen|
|[Elastique](https://www.elastique.nl/)|Hilversum, Niederlande|Elastique ist eine innovative app-Entwicklung Unternehmen|
|[EsperantoXL](http://www.esperantoxl.nl)|UTRECHT, Niederlande|EsperantoXL hat sich bei der Entwicklung von smart-softwarelösungen. Wir können Organisationen ihre Effizienz steigern, indem Sie ihre Prozesse zu rationalisieren|
|[Finaps](https://www.finaps.nl/)|Amsterdam, Niederlande|Finaps bietet innovative IT-Lösungen, die mit erweiterten Technologien wie Mendix "," SAS "," Xamarin "und"-Feld.|
|[Freigegeben](http://www.freed.nl/)|Achtkarspelen, Niederlande|Freigegebene Developes-Web-Apps und mobile apps für iOS, Android und Windows |
|[Holygrow](http://www.holygrow.nl )|Capelle Aan Den IJssel, Niederlande|Mit einer unserer Kreativität, wissen, Erfahrung und Ihre Leidenschaft erstellen wir sinnvolle digitale Produkten. Wir tun dies durch den folgenden vier davon ausgeht.|
|[i Pulse-Internet-Lösungen](http://www.i-pulse.nl)|Doetinchem, Niederlande|Ich – Pulse erstellt benutzerdefinierte Software, die sowohl Web-, app und vieles mehr|
|[Ijsberg Berater](http://www.ijsbergconsultants.nl)|Amsterdam, Niederlande|Ob es ausarbeiten, Strategie, Innovationen, Produktentwicklung, Kunden Ausrichtung oder Kommunikation bezieht, IJsberg hilft Unternehmen dabei, excel. Wir erreichen dies durch eine umfassende integrierte Ansatz formulieren|
|[Info Support b.v.](http://www.infosupport.com)|Veenendaal, Niederlande, Mechelen, Belgien|Info-Unterstützung ist, einen Spezialisten, die bei Entwicklung, Verwaltung und hosting von benutzerdefinierten Softwareupdates und Bereitstellung von BI und Integration|
|[iQuality](http://www.iquality.nl)|NIJMEGEN, Niederlande|Wir entwerfen, entwickeln und Software, apps und Websites auf der Grundlage der implementierbar unserer Kunden zu unterstützen. |
|[KEMBIT B.V.](http://www.kembit.nl/)|Wijnandsrade, Niederlande|Unser Dank gilt den vor dem überwachten Entwicklungen und die resultierenden Anforderungen vorgestellt und entsprechenden, qualitative, innovative und intelligente IT-Lösungen nutzen.|
|[KPN Consulting](https://www.kpnconsulting.nl/)|Zoetermeer, Niederlande|Der KPN Vision ist die, dass die IT ist weit mehr als die Bereitstellung der Technologie. Erhöhen die Blue Yonder des Menschen und der Organisation ist deren Priorität.|
|[Logirix](http://www.logirix.com/en/)|Groningen, Groningen|Logirix stellt benutzerfreundliche und funktionale-Schnittstellen, die Anforderungen von Endbenutzern mit Organisationsprozessen und Daten verbinden|
|[Macaw Nederland](http://www.macaw.nl)|Schiphol-Rijk, Niederlande, Barendrecht, Niederlande, Apeldoorn, Niederlande|Macaw entwirft, erstellt und verwaltet digitale technologielösungen für mobile, online, Office und Home. Spezialisten im Feld der Business-Integration, Zusammenarbeit im sozialen Netzwerk, Cloud, marketingautomation, Business Analytics und Outsourcing sind.|
|[Neue Nexus Mobile](http://www.newnexusmobile.nl)|Amsterdam BW|Neue Nexus Mobile Lösungen erstellt sowohl Geschäfts- und nutzerumgebung apps für alle Plattformen. Neue Nexus Mobile Lösungen führt Organisationen während des Prozesses: aus consulting Realisierung und Implementierung, die Wartung.|
|[Öffnen Sie Kreis Lösungen b.v.](http://www.opencirclesolutions.nl/en/)|Eindhoven, Niederlande|Öffnen von Projektmappen Kreis hat es sich um eine Aufgabe um Personen und Clients erfolgreich ist, über die Kenntnisse und Innovationen zu machen. Sie dienen dazu, und verwenden Sie Open Source-Technologie für: Geschäftsanwendungen, mobilen apps, Integration, Business Intelligence und Produktentwicklung. Ihrer Meinung nach in benutzerdefinierten Lösungen von eine Agile/Scrum-Methode, die vom Projektmanager, die nach PRINCe2 Methode hauptsächlich arbeite überwacht.|
|[Ordina ICT](https://www.ordina.com)|Nieuwegein, Niederlande, Groningen, Niederlande, Amsterdam, Niederlande, Eindhoven, Niederlande, Apeldoorn, Niederlande|Ordina erreicht ihre Mission durch nachhaltige Innovationen in Zusammenarbeit mit ihren Clients generieren. Dies erreichen sie durch Bildung einer schließende Beziehungen mit ihren Clients. Diese beginnen mit Investitionen in gegenseitige Vertrauensstellung und verstehen. Aber das ist erst der Anfang; Sie möchten bereitzustellen nachhaltige Lösungen, mit denen wirklich Personen vorwärts bewegen. Projekte und Programme entwickelt, ohne zu verschwenden, Arbeitsstunden und Ressourcen, die tun, was sie tun sollen, und sind einfach zu verwalten, die wiederum bedeutet, dass sie eine lange Lebensdauer haben.|
|[Punkt 42](http://www.point42.nl)|Reeuwijk, Niederlande|Smartphones En Tablets Halen de Gewone-Computer in Rap Tempo in LE Aantal Gebruikers. Uitstekende Gebruikservaring Op Mobiele Apparaten ist Hierdoor Belangrijker Dan Ooit. Zeigen Sie 42 Werkt Altijd Vanuit chirmaufnahme Mobile-En-Cloud an erster Gedachte En Spitst Zijn Dienstverlening Toe Op reaktionsfähig Webdesign.|
...
|[Rubicon](http://www.rubicon.nl/diensten/mobiele-apps)|Postbus 169 4130 ED Vianen|Van Visie in Warteschlangen gesamt-Strategie, die in Warteschlangen gesamt-app-Entwicklung, Entwerfen Integratie erfüllt ERP, Testen, Beheer En-Cloud. Wij Hebben Kennis van de Ervaring erfüllt Het Bouwen van Mobiele Oplossingen Würfel Passen Bij uw Individuele Behoeften En Kansen. Rubicon Ontwerpt, Ontwikkelt, test, En Beheert apps bereitgestellt werden. Erfüllt Onze "Mobile DevOps-Aanpak" Zorgen wir Voor chirmaufnahme Voorspelbare, Betrouwbare En Inzichtelijke Ontwikkel-En Beheeraanpak Voor uw apps.|
|[Versluis](https://gerald.verslu.is/)|Sittard, Niederlande|Jetzt ich vor allem auf aktuellen bin verfügt über Erstellen von apps – insbesondere, wenn die Möglichkeit von Xamarin und alles, damit zu tun haben. Jedoch eine app ist nicht abgeschlossen, ohne eine richtige Back-End, die richtige? Natürlich bin ich nicht einige ASP.NET (Core) oder anderen Webanwendungen sorgen. Ich möchte auch auf für alle Arten von anderem, wie z. B. Basteln: continuous Delivery und continuous Integration, alles, was Azure|
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[Applandeo](http://www.applandeo.com/en/)|Krakau, Polen|Applandeo ist die app und die Web-Entwicklung Unternehmen|
|[MITTL. SÜDAMERIKA ASSECO POLEN](https://pl.asseco.com/)|Rzeszów, Polen|Asseco Polen hat technologisch erweiterte softwarelösungen für Unternehmen und Bildungseinrichtungen alle Schlüssel Sektoren der Wirtschaft für mehr als 20 Jahren entwickelt|
|[Billennium](http://billennium.pl/)|Warschau, Polen |Billennium verfügt über viele Jahre Erfahrung bei der Entwicklung von innovativen Business-Tools und Lösungen.|
|[Edge-Z-o.o. einen Lösungen SP.](http://www.edge1s.com)|Warschau, Polen |Wir bieten die Kenntnisse und Erfahrungen des IT-Berater hoch qualifizierte. In jedem Dienst in unser Portfolio garantieren wir für einen flexiblen Ansatz für Anforderungen und Erwartungen der Kunden|
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[Die AD-Software-Systeme](http://www.adsoftsystems.co.za)|Kapstadt, Südafrika|AD-Softwaresysteme bietet benutzerdefinierte Web- und Mobile-Entwicklung Solutions. Sie konzentrieren sich auf die systemeigene Entwicklung, aber auch Lösungen selbst zu erstellen, können maximal wiederverwenden für alle wichtigen mobilen Plattformen|
|[CodeWrite Pty Ltd](http://www.codewrite.co.za/)|Johannesburg, Südafrika|Konzentrieren wir uns auf die Mobile-First-app-basierten und webbasierte Lösungen, umfangreiche benutzerdefinierte Enterprise-softwareanwendungen und die Integration der Sicherheit Access Control System-software|
|[Cyberlogic Pty Ltd](http://www.cyberlogic.co.za)|Kapstadt, Südafrika|Cyberlogic ist ein verwalteter Dienst-Anbieter von Cloud und verwaltete IT-Dienste mit Rechenzentren|
|[Full-Stack](http://www.fullstack.co.za/)|Kapstadt, Südafrika|Full-Stack ist ein Softwareunternehmen, das Bereitstellen von Data-Produkte und Dienste, die entwickelt, um die geschäftlichen, durch die Übermittlung von hochwertige Software rechtzeitig zu einem festen Preis nutzen.|
|[Zu den neuen Medien-Labs](http://www.newmedialabs.com)|Kapstadt, Südafrika|Wir specialise in sichere und transaktionale Webanwendungen für Finanzdienstleistungen-Clients. Diese um Systeme sind vollständig in unserer Kunden Unternehmen bedeutende Verbesserungen in Effizienz und die Möglichkeit, ihren Kunden zu interagieren bereitstellen integriert.|
|[-Paradigma-Gruppe](http://www.paradigmgroup.co.za/)|Kapstadt, Südafrika|-Paradigma-Gruppe ist die Specialist Software Development-Abteilung in der Gruppe. Benutzerdefinierte Softwareentwicklung für Unternehmen, NGO und Behörden ist dies möglich.|
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[Arendi](http://www.arendi.ch/)|Hombrechtikon, Schweiz|Arendi bietet Breite Palette von Diensten: Entwicklung von Apps, Hardware und Firmware-Entwicklung und Projektmanagement |
|[BBV Software Services AG](http://www.bbv.ch)|Zürich, Schweiz|BBV Software Services ist ein Schweizer Software und consulting-Unternehmen. Sie können mobile Lösungen entwickeln, die auf bestimmte und komplexen geschäftsanforderungen zugeschnitten sind.|
|[Noser Engineering AG](http://www.noser.com)|Winterthur, Zürich |Noser ist ein Microsoft Gold-Partner für benutzerdefinierte Entwicklung "," Mobile "und" Business-Lösungen. Microsoft hat als Gewinner 2012 mit dem Microsoft Application Lifecycle Management (ALM)-Partner Award Noser Engineering AG, ein Microsoft Gold Certified Partner, mit dem Namen. Diese Auszeichnung erkennt ausstehenden Verpflichtung zur Übermittlung von innovative Technologie, Lösungen und die höchste Qualität über best Practices für ALM-Software.|
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[Adaptive finanzielle Consulting Limited](http://weareadaptive.com)|London, Großbritannien|Adaptive finanzielle Consulting beschränkt ist, ein Beratungsunternehmen mit langjähriger Erfahrung im Finanzbereich|
|[Apptelic Ltd](http://Apptelic.com)|London, Großbritannien|Apptelic Ltd. ist ein Softwareentwicklungsunternehmen, das bei der Entwicklung von Desktop- und mobilen apps für iOS, Android, Windows und Xbox One spezialisiert.|
|[AppXib Ltd](http://www.appxib.com)|Peterborough, Vereinigtes Königreich|AppXib ist ein app-Entwicklung von Unternehmen|
|[Blaue Spatz-Apps](http://www.bluesparrowapps.com/)|Bristol, Großbritannien|Blaue Spatz-Apps ist Award-app-Entwickler die Unternehmen|
|[Chelsea Apps Factory](http://chelsea-apps.com/)|London, Großbritannien|CAF, verfügt über einen Namen für sich selbst als ein führendes UK mobile app-Entwicklung Unternehmen und der Staat größten Specialist mobile Beratung für Verbraucher- und Unternehmens-apps sehr schnell durchgeführt.|
|[Programmierte London Ltd](http://getcodified.com/)|London, Großbritannien|London führenden React Native und Xamarin Agentur|
|[Cohaesus](http://cohaesus.co.uk)|London, Großbritannien|Cohaesus erstellt native apps für einige aus den Bereichen größten Marken, alle übermittelten auf iOS-, Android- und Windows-Smartphones|
|[Contemi](http://www.contemi.com)|Lysaker, Norwegen, Lesen, Großbritannien|Contemi ist die Entwicklung von IT und Softwareentwicklung für und mit der Start-Initiativen Business-Beratungsfirma.|
|[Creative Sciences](https://creativesciences.co.uk)|London, Großbritannien|Creative Sciences bietet mobile und Webentwicklung consulting desing und support Services. |
|[Datadruid](http://www.datadruid.co.uk)|Die Bishop Stortford, Großbritannien|Bereitstellen von robusten, hoch leistungsstarke Apps und Entwicklungsdiensten. Übermittelt werden, schnell und konkurrenzfähig sein|
|[Eastpoint Software](https://www.eastpoint.co.uk/)|London, Großbritannien|Wir sind ein Safety Entwicklung Haus bereitstellen Strategie und Planung, Entwurf und UX, Entwicklung, Tests und Wartung und support|
|[Vierzig-neun-Element](http://www.elementfortynine.com)|London, Großbritannien|Vierzig-neun-Element ist eine mobile Beratung, die sich auf apps konzentrieren, plattformübergreifende mobile Entwicklung Obstbau und Maximierung von Code wiederverwenden, und gleichzeitig sicherzustellen, dass die benutzerfreundlichkeit oberste Priorität ist|
|[Everis](http://www.everis.com)|London, Großbritannien|Everis ist ein multinationales Beratungsunternehmen, das Unternehmen und strategischen Lösungen, Entwicklung und Wartung von technologischen Anwendungen und Outsourcing-Diensten bietet|
|[Fujitsu](http://www.fujitsu.com/uk/services/application-services/application-development-integration/)||Fujitsu ist das führende japanische IT- und Technologie (ICT) Unternehmen bietet eine Vielzahl von IT-Produkte, Lösungen und Diensten|
|[Futurice](http://futurice.com)|London, Großbritannien; München; Helskinki, Finnland|Seit 2001 hat mehr als tausend Projekte mit mehr als 200 Kunden Futurice gearbeitet. Sie wissen, wie Sie Ihre innovative Ideen zu generieren, und verwandeln Sie sie in der Software, die funktioniert|
|[Grove-Gruppe](http://www.groveis.com/)|London, Großbritannien; Johannesburg, Südafrika|Am Groove entsperren wir Geschäftserfolg-Technologie. Wir helfen Ihnen und Ihrem Unternehmen Ihr Potenzial über die Leistungsfähigkeit von hochmodernen Cloud Computing, benutzerdefinierte Softwareentwicklung, internetsicherheit und Analysen zu erfüllen.|
|[Guimak Ltd.](http://www.guimak.com)|London, Großbritannien|Eine Spiele-Unternehmen für Softwareentwicklung|
|[In der Hand Ltd](http://inthehand.com )|Newport, Shropshire, Großbritannien|Die Ltd. manuell erstellt, apps und Komponenten für Mobile, mixed Reality- und IoT-Systeme|
|[iOS-BITS](http://iosbits.co.uk)|London, Großbritannien|iOS-BITS sind mobile Innovation hilfreich. Sie wissen, wie Sie leistungsfähige benutzerumgebungen und Business-Tools über kreative Einsatz von neuen Technologien zu erstellen|
|[iScientia Limited](http://www.iscientia.co.uk/)|Surrey, Großbritannien|Wir bieten Informationen Systeme Beratung und Lösungen vor allem für die Zahlung, Einzelhandel und Gastgewerbe Branchen.|
|[Mikrosekunden](http://www.microsec.co.uk/)|Hampshire, Großbritannien|Über die letzten drei Jahrzehnten Mikrosekunden entworfen, entwickelt und haben softwarelösungen mit praktisch jeder Technologie in der grundlegenden Verwendung unterstützt.|
|[Motech Ltd.](http://www.motechltd.com)|London, Großbritannien; Riga, Lettland|Motech Ltd Enterprise Mobile-Lösungen ist eine internationale IT-Unternehmen nutzen 12 + Jahre Erfahrung bei der Übermittlung von Enterprise-apps für globale Unternehmen mit den besten Wert im Unternehmen Mobile Apps|
|[Pixel Management Ltd](http://pml.co.uk)|Solihull, Midlands, Westen, Großbritannien|Die PML Projekte enthalten, kommerziellen Organisationen und Bildungseinrichtungen unternehmensanwendungen. Die Unternehmens-Kernkompetenzen erstrecken, mehrere Programmiersprachen, native Mobile und Cloudentwicklung, komplexe Sicherheitssysteme, immer noch ein Image erstellen, Komprimierung und streaming. |
|[Proto-Software](https://www.protosoftware.co.uk/)|Vereinigtes Königreich|Wir können mobile apps für Ihr Unternehmen auf verschiedensten Plattformen einschließlich iOS, Android und Windows bietet Ihnen eine Reichweite von mehr als 3 Mrd. potenzielle Kunden zu entwickeln. |
|[Nicht selten möglich](http://www.rarelyimpossible.com)|Bournemouth, Großbritannien|Nur selten möglich Hilfe Unternehmen erstellen Sie mobile apps und IoT-Cloud-Lösungen für Geschäftsprobleme mit dem Schwerpunkt auf die benutzerfreundlichkeit bei der sowohl Entwurfs- und Entwicklungsphasen. Über die Projekte und Produkte, die wir für unsere Kunden zu erstellen ist unser Ziel alle Benutzer innerhalb einer Organisation mit Tools zu ermöglichen, die sie bei ihren täglich zu unterstützen.|
|[Rock solide Kenntnisse](http://www.rocksolidknowledge.com)|Bristol, Großbritannien|Wie Xamarin Partner Wir erstellen mobile Lösungen für datenplattformen in mithilfe von Xamarin.Forms und native Benutzeroberfläche für iOS und Android überschreiten. Wir sind Erfahrung im Entwickeln von Lösungen, die ermöglichen, dass native Benutzeroberfläche können Sie bei der alle freizugeben oder einen viel Code zwischen den Plattformen.|
|[Screenmedia](http://www.screenmedia.co.uk)|Glasgow, Großbritannien|Screenmedia ist davon überzeugt, dass zum Erstellen von Menschen – wobei Lösungen für Clients und Endbenutzer, sie einem menschlichen zentriertem Unternehmen sein müssen. Ihre Vision und die Werte widerspiegeln, die vollständig, und natürlich ist dies auch für ihre Mitarbeiter. Die Screenmedia Praxis Kultur ist der Schlüssel zum Erfolg. Es ist was Laufwerke und ihre Innovationen in neue Technologien aushält; unterstützt erstellt agile Partnerschaften mit Clients. und es ist sehr anspruchsvoll Arbeit angenehme macht.|
|[Sequence](https://www.sequence.co.uk/)|Cardiff, Großbritannien; London, Großbritannien|Sequenz ist eine kreative digital-Agentur, die im Jahr 1995 hergestellt. Obstbau Design, Strategie und benutzererfahrung, haben sie einige der größten Internetportal-Organisationen in Branchen, die von der Fertigung bis hin zu Reise- und Tourismusbranche gearbeitet. Verbinden Marken, mit Kunden über die Leidenschaft und Innovationen zu bieten.|
|[ShinobiSolutions](https://www.shinobicontrols.com/shinobienterprise)|Newcastle Upon Tyne und, Großbritannien|Seit seiner Einführung im Jahr 2011 wurde Shinobicontrols umfassende und leistungsstarke interaktiven Benutzeroberflächen-Steuerelemente für IOS- und Android-Entwickler erstellt. Von 2012 starten sie Shinobicharts, ihre erste Produkt. Seit damals haben schnell gewachsen und jetzt bieten benutzeroberflächenlösungen für Tausende von Kunden mit unserem schnell wachsende Portfolio von Produkten.|
|[Skillweb](http://www.skillweb.co.uk)|Hohe Wycombe, Großbritannien|Skillweb gilt für private "," Vereinigtes Königreich basierende Unternehmen, die technologielösungen soll helfen, Organisationen, die ihre mobilen Mitarbeiter zu verwalten und verfolgen die Verschiebung von ihrer Waren bereitstellt. Das Unternehmen hat seit 1999 Verwalten von Bereitstellungen im Vereinigten Königreich und Europa betrieben und ist verantwortlich für bis zu 100 Millionen Transaktionen pro Monat und wächst.|
|[Software, die gelöst](http://www.softwaresolved.com/)|Exeter, Großbritannien; London, Großbritannien; Manchester, Großbritannien|Langfristige Partnerschaften erstellen mit unseren Kunden, die basierend auf Vertrauenswürdigkeit und die Übermittlung der ausstehenden Software. Wir sind ein Microsoft Gold-Partner aus, und unsere Prozesse sind ISO 9001 zertifiziert.  Dies bedeutet, dass wir die höchste Qualitätsstandards in der Softwareentwicklung akkreditiert sind.|
|[StyleTech](https://www.styletech.co.uk/)|Hülle, Großbritannien|Werden-Spezialisten zusammen, um Software, entwickeln innovative, maßgeschneiderte Lösungen, um die Anforderungen unserer Kunden zu erfüllen, und zugleich Unterstützung, Wartung und Legacysysteme zu verbessern. Betriebssystem seit 1999, wir nicht zuletzt verfügen über eine Erfolgsgeschichte von mehr als 1.000 um Softwareprojekte für ein breites Spektrum von Clients aus öffentlichen und privaten Sektor bereit, die wir specialise im Gesundheitswesen, wissenschaftlichen, Transport, Fertigung und Technologie Branchen. Mit einer Kultur intuitiv und benutzerfreundlich bieten wir immer eine fokussierte, Dienstqualität für alle unsere Kunden. Arbeiten mit Xamarin, Xamarin Test Cloud und Azure-Experten zu Mobile werden, tablet, Cloud, Web oder Desktop-Entwicklung, und wenden Sie bewährte Methode immer auf den Bereichen Analyse, Entwurf, Sicherheit, testen und Integration.|
|[Superluminal](http://www.superluminalsoftware.co.uk)|Oxford, Großbritannien|Nachfolgend finden Sie unter Superluminal wir Softwareentwickler, damit wir unsere Software von Grund auf neu entwerfen, erstellen wichtige Systeme, die für Prozess "und" hyper-Gebühren Ihres Unternehmens ausgerichtet sind. Wir können auch verwalten und aktualisieren Sie Ihr aktuelle System aus, wenn dessen Beginn behindern oder die Änderung um geschäftsanforderungen zu erfüllen.|
|[Die individuelle App Company Limited](http://www.thebespokeappcompany.co.uk)|Barrowford, Großbritannien; North West Leicestershire Bezirk, Großbritannien||
|[Thumbmunkeys Ltd](http://www.thumbmunkeys.com)|York, North Yorkshire, Großbritannien|Mit einem Datensatz nachverfolgen, der umfasst das Erstellen von Verbraucher-apps mit mehr als 30 Millionen Downloads, wissen Thumbmunkeys, wie eine wirklich herausragende und sich an den Benutzer Mobilgeräte zu erstellen. Unsere UK basieren Team aus Profi-Entwicklern aus, und Designer bieten eine maßgeschneiderte End-to-End-Lösung von Beratung, zum Erstellen von Prototypen, Design von Benutzeroberfläche/UX, plattformübergreifende Entwicklung, Cloud-Entwicklung und laufende technischen Support.|
|[VoxDev Ltd](http://www.voxdevmobile.com)|Durham, Großbritannien|VoxDev wurde 2003 gebildet und aus unserer Basis-in Durham, in den Nord Osten von England haben erfolgreich halfen wir Clients mit ihrer Softwareprojekte von Website erstellen, desktopanwendungen und mobilen Anwendungen.|
|[Waterstons LTD](https://waterstons.com)|Durham, Großbritannien|Erstellen Sie eine bessere geschäftliche. Über Technologien, benutzerfreundlichkeit und die Verpflichtung funktioniert Waterstons mit Hunderten von Clients, Groß und klein, um ihr Unternehmen zu verbessern.|
|[Erweitern von IT](http://www.xpand-it.com)|Lissabon, Portugal, London, Großbritannien|Mit Jahren Erfahrung in der mobilen Welt und mehr als 130 Mobile Apps verfügbar in der verschiedene Marketplaces ist erweitern IT führend in Unternehmensdiensten für Mobile Anwendungen.|
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[FreezePro Software](http://freezeprosoftware.com)|Lviv, Ukraine|FreezePro-Software ist eine benutzerdefinierte offshore-Softwareentwicklung und Outsourcing-Unternehmen. Es wurde von einfallsreiche-Experten mit starken IT-Hintergrund eingerichtet.|
...
| Partner | Speicherorte | Beschreibung |
| --- | --- | --- |
|[DVLUP](http://www.dvlup.net/)|Ho-Chi-Minh-Stadt, Vietnam|Dev-nach-oben wurde mit der Mission, Ebene oberhalb Vietnam Entwickler von Dev Communityexperten gegründet.|
|[FPT Software Hanoi Company Limited](http://www.fpt-software.com/)|Hanoi, Vietnam|Vietnam des größten und eine der am schnellsten wachsende digitale Transformation Services-Anbieters.|
