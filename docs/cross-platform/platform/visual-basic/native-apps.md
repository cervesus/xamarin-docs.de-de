...
description: In dieser exemplarischen Vorgehensweise veranschaulicht, wie systemeigene Xamarin.iOS und Xamarin.Android-apps erstellen, die in Visual Basic geschriebene Geschäftslogik verwendet wird.
ms.prod: xamarin
