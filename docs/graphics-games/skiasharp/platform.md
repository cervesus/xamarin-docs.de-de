---
title: Spezifische Details SkiaSharp-Plattform
description: 'Informationen zur Verwendung von SkiaSharp in Ihre Plattform. kurze: Geben Sie Details zum Inhalt Ihres SkSurface in Ihre systemeigene Anwendung einfügen.'
ms.prod: xamarin
...
---
# <a name="platform-specific-integration"></a>Bestimmte Plattformintegration
