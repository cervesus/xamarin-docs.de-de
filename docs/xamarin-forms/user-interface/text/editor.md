...
description: In diesem Artikel wird erläutert, wie Sie das Xamarin.Forms-Editor-Steuerelement um für mehrzeilige Texteingabe in einer Anwendung zu akzeptieren.
ms.prod: xamarin
