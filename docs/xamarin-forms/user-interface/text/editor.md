...
Beispiele für die einzelnen Tastatur finden Sie in unserem [Rezepte](https://developer.xamarin.com/recipes/cross-platform/xamarin-forms/choose-keyboard-for-entry/) Repository.
