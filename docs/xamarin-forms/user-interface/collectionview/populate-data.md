...
In diesem Beispiel werden die [`ItemsSource`](xref:Xamarin.Forms.ItemsView.ItemsSource) Eigenschaften Daten an die `Monkeys` -Eigenschaft des verbundenen Ansichts Modells gebunden.
