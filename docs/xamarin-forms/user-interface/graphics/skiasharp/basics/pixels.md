...
description: In diesem Artikel wird erklärt, die Unterschiede zwischen SkiaSharp und Xamarin.Forms-Koordinaten, und dies mit Beispielcode veranschaulicht.
ms.prod: xamarin
