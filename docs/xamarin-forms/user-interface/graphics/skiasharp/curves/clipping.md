...
description: In diesem Artikel wird erläutert, wie Sie skiasharp-Pfade verwenden, um Grafiken in bestimmte Bereiche zu schneiden und um Regionen zu erstellen, und dies mit Beispielcode veranschaulicht.
ms.prod: xamarin
