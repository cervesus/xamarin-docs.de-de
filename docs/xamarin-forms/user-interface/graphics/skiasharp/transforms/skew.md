...
description: In diesem Artikel wird erläutert, wie die Neigung Transformation Geneigter Grafikobjekte in SkiaSharp erstellen kann, und dies mit Beispielcode veranschaulicht.
ms.prod: xamarin
