...
description: Verkaufsrabatte-Artikel untersucht die SkiaSharp Skalierungstransformation für die Skalierung der Objekte in verschiedenen Größen und mit Beispielcode veranschaulicht dies.
ms.prod: xamarin
