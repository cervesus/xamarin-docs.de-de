---
title: Zugreifen auf skiasharp-Bitmap-Pixel Bits
description: Entdecken Sie die verschiedenen Techniken für den Zugriff auf und die Änderung der Pixelbits von skiasharp-Bitmaps.
ms.prod: xamarin
