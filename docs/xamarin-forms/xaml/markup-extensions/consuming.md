...
Beachten Sie, dass es *keine* Anführungszeichen innerhalb der geschweiften Klammern gibt. Die `Member`-Eigenschaft von `StaticExtension` ist nicht mehr ein XML-Attribut. Stattdessen ist er Teil des Ausdrucks für die Markuperweiterung.
