...
| <h3>Swidansicht</h3> Stellt Kontextmenü Elemente bereit, die durch eine Schwenkbewegung angezeigt werden.<p align="center">![Screenshot einer swidanview](xaml-controls-images/SwipeView.png "Swidansicht")</p>[Lenken](~/xamarin-forms/user-interface/swipeview.md) | <p valign="center"><pre>&lt;SwipeView&gt;<br />    &lt;SwipeView.LeftItems&gt;<br />        &lt;SwipeItems&gt;<br />            &lt;SwipeItem Text="Delete"<br />                       IconImageSource="delete.png"<br />                       BackgroundColor="LightPink"<br />                       Invoked="OnDeleteInvoked" /&gt;<br />        &lt;/SwipeItems&gt;<br />    &lt;/SwipeView.LeftItems&gt;<br />    &lt;!-- Content --&gt;<br />&lt;/SwipeView&gt;</pre></p> |
|     |     |
...
| <h3>Indikator Ansicht</h3>Zeigt Indikatoren an, die die Anzahl der Elemente in einer `CarouselView`darstellen.<p align="center">![Screenshot einer "indikatorview"](xaml-controls-images/IndicatorView.png "Indikator Ansicht")</p>[Lenken](~/xamarin-forms/user-interface/indicatorview.md) | <p valign="center"><pre>&lt;IndicatorView ItemsSourceBy="carouselView"<br />               IndicatorColor="LightGray"<br />               SelectedIndicatorColor="DarkGray" /&gt;</pre></p> |
