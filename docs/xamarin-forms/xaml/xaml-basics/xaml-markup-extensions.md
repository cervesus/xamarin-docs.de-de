...
- Sie können Arrays in XAML mithilfe der `x:Array` Markup Erweiterung definieren. Diese Markuperweiterung ist ein erforderliches Attribut, das mit dem Namen `Type` , der den Typ der Elemente im Array angibt.
