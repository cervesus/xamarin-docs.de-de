...
ms.locfileid: "54207777"
---
# <a name="android-platform-features"></a>Android-Plattformfeatures

Entwickeln von Xamarin.Forms-Anwendungen für Android benötigt Visual Studio. Die [Seite "speicherplatzanforderungen"](~/xamarin-forms/get-started/installation.md) enthält weitere Informationen zu den Voraussetzungen.
