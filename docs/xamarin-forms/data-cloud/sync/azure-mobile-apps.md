...
description: Dieser Artikel beschreibt, wie offline Sync-Funktionen zu einer Xamarin.Forms-Anwendung hinzugefügt, die eine Azure Mobile Apps Back-End-nutzt.
ms.prod: xamarin
