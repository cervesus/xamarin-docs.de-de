...
|Neues to-do-Element erstellen|Bereitstellen|/api/todoitems/|Ein JSON-formatiertes "$ doitem"|
|Aktualisieren eines To-Do-Elements|Stellte|/api/todoitems/|Ein JSON-formatiertes "$ doitem"|
|Löschen eines To-Do-Elements|DELETE|/api/todoitems/{id}|

Die meisten URIs enthalten die `TodoItem`-ID im Pfad. Um z. b. den `TodoItem`, dessen ID `6bb8a868-dba1-4f1a-93b7-24ebce87e243`ist, zu löschen, sendet der Client eine DELETE-Anforderung an `http://hostname/api/todoitems/6bb8a868-dba1-4f1a-93b7-24ebce87e243`. Weitere Informationen zum Datenmodell, das in der Beispielanwendung verwendet wird, finden Sie unter [Modellieren der Daten](~/xamarin-forms/data-cloud/web-services/introduction.md).
