...
description: Dieser Artikel veranschaulicht, wie einen WCF SOAP Simple Object Access Protocol ()-Dienst über eine Xamarin.Forms-Anwendung genutzt wird.
ms.prod: xamarin
