...
|Ein neues Aufgabenelement erstellen|POST|/api/todoitems/|Eine JSON-Format TodoItem|
|Aktualisieren eines To-Do-Elements|PUT|/api/todoitems/|Eine JSON-Format TodoItem|
