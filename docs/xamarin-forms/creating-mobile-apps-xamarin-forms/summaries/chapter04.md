...
Legen Sie die [ `Spacing` ](xref:Xamarin.Forms.StackLayout.Spacing) Eigenschaft `StackLayout` auf eine `double` Wert, der einen Abstand zwischen der untergeordneten Elemente angegeben. Der Standardwert ist 6.
