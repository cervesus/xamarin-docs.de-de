...
description: 'Erstellen von Mobile Apps mit xamarin. Forms: Zusammenfassung der Kapitel 26. Benutzerdefinierte layouts'
ms.prod: xamarin
...
## <a name="deriving-from-layoutview"></a>Ableiten von der\<Layoutansicht >
