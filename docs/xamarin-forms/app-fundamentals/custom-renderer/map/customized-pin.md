...
Diese Klasse definiert ein `CustomPin` als erben die Eigenschaften der [ `Pin` ](https://developer.xamarin.com/api/type/Xamarin.Forms.Maps.Pin/) Klasse und das Hinzufügen von `Id`, und `Url` Eigenschaften.
