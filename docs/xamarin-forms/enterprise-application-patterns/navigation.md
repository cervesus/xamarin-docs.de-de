...
Wenn die app gestartet wird, die `InitNavigation` -Methode in der die `App` -Klasse aufgerufen wird. Im folgenden Codebeispiel wird diese Methode veranschaulicht:
