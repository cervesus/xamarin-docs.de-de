...
#### <a name="mm0000-unexpected-error---please-file-a-bug-report-at-httpbugzillaxamarincom"></a>MM0000: Unerwarteter Fehler: Datei einen Fehler melden an http://bugzilla.xamarin.com

Ein unerwarteter Fehler ist aufgetreten. Bitte [einen Fehlerbericht](https://bugzilla.xamarin.com/enter_bug.cgi?product=Xamarin.Mac) so viele Informationen wie möglich, einschließlich:
