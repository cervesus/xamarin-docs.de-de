...
description: Dieses Dokument enthält Fehler, die vom Mmp verwendetes Tool zum kompilierte Assemblys in eine ausführbare Anwendung für Macintosh-Paket generiert.
