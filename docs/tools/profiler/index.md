...
> [!NOTE]
> Sie müssen werden eine [Visual Studio Enterprise](https://visualstudio.microsoft.com/vs/compare/) Abonnenten für diese Funktion entweder Visual Studio Enterprise unter Windows oder Visual Studio für Mac auf einem Macintosh-Computer zu entsperren
