...
- [**FAKE** ](http://fsharp.github.io/FAKE/) – Hierbei handelt es sich um eine DSL, die auf F# basiert, wodurch auch vorhandene .NET Bibliotheken benutzt werden können, falls erforderlich.
