...
description: Dieses Dokument beschreibt fortlaufende Integration mit Xamarin. Darin werden die Versionskontrolle sowie die verschiedenen continuous Integration-Umgebung erläutert.
ms.prod: xamarin
