...
description: Dieses Dokument beschreibt, wie die Xamarin-Live-Player einrichten und verwenden, um die live-Änderungen an einer ausgeführten Anwendung vornehmen.
ms.prod: xamarin
