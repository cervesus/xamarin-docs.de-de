...
> [!NOTE]
> Hinweis: APIs für die müssen öffentlich sein, aber nicht über IntelliSense angefügt werden soll kann gekennzeichnet werden mit der üblichen `[EditorBrowsable (EditorBrowsableState.Never)]` Attribut.
