...
- `Dictionary`  **Domain-Name-for-Exception-As-String>()-eineAuflistungvonAusnahmenfüreinebestimmteDomäne\<** (z. b. `www.xamarin.com`) angezeigt wird.
