...
##### [Konfigurieren von Visual Studio 2017](get-started/installation/windows/config-options.md)
#### [Einrichten eines Geräts für die Entwicklung](get-started/installation/device-provisioning/index.md)
...
##### [Kostenlose Bereitstellung](get-started/installation/device-provisioning/free-provisioning.md)
...
### [Zugriff](app-fundamentals/accessibility.md)
...
#### [Exemplarische Vorgehensweise: Verwenden der Toucheingabe in iOS](app-fundamentals/touch/ios-touch-walkthrough.md)
...
#### [Ziel](platform/introduction-to-ios11/vision.md)
...
### [Plattformerweiterungen (Size, Rectangle, Point)](~/essentials/platform-extensions.md?context=xamarin/ios)
...
##### [Schritt 1. Register](~/cross-platform/data-cloud/active-directory/get-started/register.md?context=xamarin/ios)
...
#### [Einführung](data-cloud/data/introduction.md)
...
### [<legacyBold>System.Data</legacyBold>](data-cloud/system.data.md)
...
#### [Die „iTunesMetadata.plist“-Datei](deploy-test/app-distribution/itunesmetadata.md)
...
### [Unittests](deploy-test/touch.unit.md)
...
###### [Erweitert (Leitfaden)](~/cross-platform/macios/binding/objective-sharpie/examples/advanced.md?context=xamarin/ios)
...
### [Registrierung](internals/registrar.md)
## [Problembehandlung](troubleshooting/index.md)
### [Hinweise zur Fehlerbehebung](troubleshooting/troubleshooting.md)
...
#### [Kann ich einen virtuellen Mac-Computer mit Xamarin verwenden?](troubleshooting/questions/mac-vm.md)
...
#### [Einführung in watchOS 5](watchos/get-started/intro-to-watchos.md)
...
### [Application Fundamentals (Anwendungsgrundlagen)](watchos/app-fundamentals/index.md)
...
#### [Bild](watchos/user-interface/image.md)
#### [Tabelle](watchos/user-interface/table.md)
...
#### [Auflistungsansichten](tvos/user-interface/collection-views.md)
...
## [Versionshinweise](https://docs.microsoft.com/xamarin/ios/release-notes/)
