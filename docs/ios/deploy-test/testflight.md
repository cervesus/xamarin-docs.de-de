...
[ ![](testflight-images/validate-build.png "Übermitteln der App an Apple")](testflight-images/validate-build.png)
...
2.  Wählen Sie **Meine Apps** aus:
    ...
    [ ![](testflight-images/my-apps.png "Wählen Sie „Meine Apps“ aus")](testflight-images/my-apps.png)
...
[ ![](testflight-images/infoplist.png "Die Datei „Info.plist“ der App")](testflight-images/infoplist.png)
[ ![](testflight-images/newiosapp.png "Das Formular in iTunes Connect")](testflight-images/newiosapp.png)
...
###  <a name="create-an-archive"></a>Erstellen eines Archivs
 ...
 [ ![](testflight-images/new-archive.png "Wählen Sie „Für Veröffentlichung aktivieren“ aus")](testflight-images/new-archive.png)
...
[ ![](testflight-images/archive-view.png "Beim Erstellen eines Archivs öffnet sich automatisch die Ansicht „Archive“")](testflight-images/archive-view.png)
...
[ ![](testflight-images/group.png "Wählen Sie auf der Seite „Bereitstellungsprofil“ Ihre Signieridentität sowie das entsprechende Bereitstellungsprofil aus, oder signieren Sie mit einer anderen Identität erneut")](testflight-images/group.png)
...
[![ ] (testflight-images/app-uploaded.png "Registerkarten „Builds“, „Interne Tester“ und „Externe Tester“")](testflight-images/app-uploaded.png)

Um Metadaten zu Ihrer App hinzuzufügen, klicken Sie auf die Buildnummer und anschließend auf TestFlight:

[![ ] (testflight-images/metadata.png "Hinzufügen von Metadaten")](testflight-images/metadata.png)
...
[ ![](testflight-images/turn-on-testing.png "Aktivieren Sie den Switch „TestFlight Beta Testing“")](testflight-images/turn-on-testing.png)
...
[ ![](testflight-images/daysleft.png "Die Seite „Testinformationen“")](testflight-images/daysleft.png)
...
[ ![](testflight-images/users-and-roles.png "Benutzer und Rollen auf dem iTunes Connect-Hauptbildschirm")](testflight-images/users-and-roles.png)
...
[ ![](testflight-images/internal-tester.png "Aktivieren Sie den Switch „Interner Tester“")](testflight-images/internal-tester.png)
...
[ ![](testflight-images/add-new-user.png "Hinzufügen eines Benutzers")](testflight-images/add-new-user.png)
...
[ ![](testflight-images/select-users.png "Eine Liste der Benutzer, die internen Betatests für TestFlight hinzugefügt wurden")](testflight-images/select-users.png)
...
[ ![](testflight-images/status-added.png "Der Status der Einladung")](testflight-images/status-added.png)
...
[ ![](testflight-images/beta-app-review.png "Für Prüfung der Beta-App senden")](testflight-images/beta-app-review.png)
...
[ ![](testflight-images/add-external.png "Tester einladen")](testflight-images/add-external.png)
...
[ ![](testflight-images/confirm-consent.png "Bestätigen Sie, dass Sie die Zustimmung der Benutzer haben, sie einzuladen")](testflight-images/confirm-consent.png)
...
[ ![](testflight-images/tester-email.png "Ein Beispiel einer E-Mail-Einladung")](testflight-images/tester-email.png)
...
[ ![](testflight-images/install-app.png "TestFlight zeigt Details, worauf getestet wird")](testflight-images/install-app.png)
...
[ ![](testflight-images/submit-for-review.png "Klicken Sie auf die Schaltfläche „Zur Überprüfung übermitteln“")](testflight-images/submit-for-review.png)
