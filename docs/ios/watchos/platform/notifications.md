...
In der [Watch Kit Katalog](https://developer.xamarin.com/samples/monotouch/watchOS/WatchKitCatalog/) Beispiel gibt es ist eine JSON-Beispieldatei Nutzlast **NotificationPayload.json** (siehe unten).
