...
description: Dieses Dokument beschreibt die iCloud und dessen Verwendung im Xamarin.iOS Anwendungen. Es wird erläutert, Schlüssel-Wert-Speicher, dokumentspeicherung und iCloud-Sicherung.
ms.prod: xamarin
