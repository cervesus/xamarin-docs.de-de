...
[![Das monkeychat-Symbol](understanding-sirikit-images/monkeychat01.png)](understanding-sirikit-images/monkeychat01.png#lightbox)
...
_Benutzer: Hey Siri, sendet eine monkeychat-Nachricht._<br />
_Siri: wem?_<br />
_Benutzer: Bobo._<br />
_Siri: Was möchten Sie an Bobo sagen?_<br />
...
_Benutzer: senden Sie eine Nachricht an Bobo auf monkeychat._<br />
_Siri: Was möchten Sie an Bobo sagen?_<br />
_Benutzer: senden Sie weitere Bananen._<br />
...
_Siri: OK, Senden von Nachrichten senden Sie weitere Bananen an Bobo auf monkeychat._<br />

Sie können auch dieselbe Anforderung in einer anderen Sprache ausführen:

_Benutzer: monkeychat Bobo-s, IL, plaît Envoyer plus de Bananes._<br />
_Siri: Oui, envoi-Nachricht, ' il, plaît Envoyer ' plus de Bananes à Bobo sur monkeychat._<br />

Ein anderer Benutzer ist in der Konversation jedoch möglicherweise sehr ausführlich:

_Benutzer: Hey Siri, können Sie mich bevorzugen und die monkeychat-app starten, um einen Text mit der Nachricht zu senden. senden Sie weitere Bananen._<br />
_Siri: wem?_<br />
_Benutzer: meine beste PAL-Bobo._<br />
...
[![Die Schritte, die von Siri befolgt werden.](understanding-sirikit-images/monkeychat02.png)](understanding-sirikit-images/monkeychat02.png#lightbox)
...
[![Die drei wichtigsten Möglichkeiten, dass die APP an der Benutzer Konversation mit Siri teilnehmen kann.](understanding-sirikit-images/monkeychat03.png)](understanding-sirikit-images/monkeychat03.png#lightbox)
...
_Benutzer: Hey Siri, sendet eine Nachricht an Bobo auf monkeychat._<br />
_Siri: Was möchten Sie an Bobo sagen?_<br />
_Benutzer: senden Sie weitere Bananen._<br />
...
[![Unterstützung von Siri bei der sprach sprechungssprache](understanding-sirikit-images/monkeychat04.png)](understanding-sirikit-images/monkeychat04.png#lightbox)
...
Siri weiß, dass mehr erforderlich ist, um eine Nachricht zu senden, als nur ein Empfänger, sodass Sie schnell mit der APP-Erweiterung überprüfen kann, ob eine Nachricht Inhalte erfordert. Da monkeychat dies tut, antwortet Siri an den Benutzer mit der Frage: *"Was möchten Sie an Bobo sagen?"*
...
[![Siri bündelt die Antwort des Benutzers in eine strukturierte Absicht](understanding-sirikit-images/monkeychat05.png)](understanding-sirikit-images/monkeychat05.png#lightbox)
...
- **Absicht:** SendMessage
- **Empfänger:** Bos
- **Inhalt:** Senden Sie weitere Bananen
...
Schließlich enthält die intentresponse eine (z `NSUserActivity` . b. die, die zur Unterstützung von Hand Eingaben verwendet werden). `NSUserActivity`Wird verwendet, um die APP zu starten, wenn die Antwort erfordert, dass Sie die SIRI-Umgebung verlassen und die app eingeben, um Sie abzuschließen.

Siri erstellt automatisch einen geeigneten `NSUserActivity` , um die APP zu starten und zu Abholung, wo der Benutzer in der SIRI-Umgebung aufgehört hat. Die APP kann jedoch eine eigene mit Benutzer `NSUserActivity` definierten Informationen bereitstellen, wenn dies erforderlich ist.
...
[![Die Ergebnisse werden dem Benutzer sowohl verbal als auch visuell angezeigt.](understanding-sirikit-images/monkeychat06.png)](understanding-sirikit-images/monkeychat06.png#lightbox)
...
[![Der Intent-Lebenszyklus](understanding-sirikit-images/monkeychat07.png)](understanding-sirikit-images/monkeychat07.png#lightbox)
...
[![Intents-Erweiterung](understanding-sirikit-images/intents01.png)](understanding-sirikit-images/intents01.png#lightbox)
...
[![Beispiel Intents-Benutzeroberflächen-Erweiterungs Ausgabe](understanding-sirikit-images/intents02.png)](understanding-sirikit-images/intents02.png#lightbox)

Die Intents-Benutzeroberflächen Erweiterung gibt immer eine zurück `UIViewController` , und die APP kann alle Elemente hinzufügen, die Sie im Ansichts Controller anweist, z. b. zusätzliche Informationen, die über die erste Antwort hinausgehen. Die Intents-Benutzeroberfläche kann den Benutzer auch mit dem Status eines Ereignisses mit langer Laufzeit aktualisieren, z. b. wie viel länger eine Fahrt Freigabe Wagen hat, um Ihren Standort zu erreichen.
...
Eine Vokabulardatei besteht aus mehreren Teilen `AppIntentVocabulary.plist` :
