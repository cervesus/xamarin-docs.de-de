...
- **Geräteauswahl**: Wählt aus, welches physische Gerät oder welcher ausgeführte Emulator überwacht werden soll.
...
Sie haben auch die Möglichkeit, mithilfe von `Console.WriteLine` in das **Debugprotokoll** zu schreiben. Dann werden die Nachrichten in Logcat in einem etwas anderen Ausgabeformat angezeigt. Dies ist besonders nützlich, wenn Sie Xamarin.Forms-Apps unter Android debuggen:
