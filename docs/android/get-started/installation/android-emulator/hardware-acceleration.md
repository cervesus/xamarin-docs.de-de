...
description: In diesem Artikel wird erläutert, wie Sie die Features für die Hardwarebeschleunigung Ihres Computers verwenden können, um die Leistung des Google Android-Emulators zu optimieren.
ms.prod: xamarin
...
ms.locfileid: "34806815"
---
# <a name="hardware-acceleration-for-emulator-performance"></a>Hardwarebeschleunigung für verbesserte Leistung des Emulators

_In diesem Artikel wird erläutert, wie Sie die Features für die Hardwarebeschleunigung Ihres Computers verwenden können, um die Leistung des Google Android-Emulators zu optimieren._

## <a name="overview"></a>Übersicht

Visual Studio erleichtert es Entwicklern, ihre Xamarin.Android-Anwendungen mithilfe des Google Android-Emulators zu testen und zu debuggen, wenn kein Android-Gerät verfügbar oder dessen Verwendung unpraktisch ist.
...
1. **Microsoft Hyper-V und die Hypervisor-Plattform** Hyper-V ist ein Virtualisierungsfeature von Windows, mit dem virtualisierte Computersysteme auf einem physischen Hostcomputer ausgeführt werden können. Dies ist die empfohlene Virtualisierungstechnologie für die Beschleunigung des Google Android-Emulators. Weitere Informationen zu Hyper-V finden Sie unter [Hyper-V unter Windows 10](https://docs.microsoft.com/en-us/virtualization/hyper-v-on-windows/).
...
Der Google Android-Emulator verwendet die Hardwarebeschleunigung automatisch, wenn folgende Kriterien erfüllt sind:
...
Weitere Informationen zum Starten und Debuggen mit dem Android-Emulator finden Sie unter [Debuggen mit dem Google Android-Emulator](~/android/deploy-test/debugging/android-sdk-emulator/index.md).
...
Entwicklern, die Windows 10 (Update von April 2018 oder höher) verwenden, wird dringend empfohlen, Microsoft Hyper-V zu verwenden, um den Google Android-Emulator zu beschleunigen. So verwenden Sie den Google Android-Emulator mit Hyper-V:
...
3. **Installieren Sie [Visual Studio 15.8 Preview 1 oder höher](https://www.visualstudio.com/vs/preview/).**
   Diese Version von Visual Studio bietet IDE-Unterstützung für das Ausführen des Google Android-Emulators mit Hyper-V.
 
4. **Installieren Sie den Google Android-Emulator (Paket 27.2.7 oder höher).** Navigieren Sie in Visual Studio zu **Extras > Android > Android SDK-Manager**, um dieses Paket zu installieren. Klicken Sie auf die Registerkarte **Extras**, und vergewissern Sie sich, dass die Version des Android-Emulators mindestens 27.2.7 ist. Stellen Sie ebenfalls sicher, dass Sie Version 26.1.1 oder höher von Android SDK Tools verwenden:
