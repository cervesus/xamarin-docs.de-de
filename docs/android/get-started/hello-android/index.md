...
## <a name="part-1-quickstart"></a>[Teil 1: Schnellstart](~/android/get-started/hello-android/hello-android-quickstart.md)
...
## <a name="part-2-deep-dive"></a>[Teil 2: Ausführliche Erläuterungen](~/android/get-started/hello-android/hello-android-deepdive.md)
