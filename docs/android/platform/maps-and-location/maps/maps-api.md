...
### <a name="obtain-a-google-maps-api-key"></a><a name="obtain-maps-key"></a>Abrufen eines Google Maps-API-Schlüssels
...
### <a name="install-the-google-play-services-sdk"></a><a name="install-gps-sdk"></a> Installieren des Google Play Services SDK
...
### <a name="install-the-xamaringoogleplayservicesmaps-package-from-nuget"></a><a name="install-gpsmaps-nuget"></a> Installieren des Xamarin.GooglePlayServices.Maps-Pakets von NuGet
...
### <a name="specify-the-required-permissions"></a><a name="declare-permissions"></a> Angeben der erforderlichen Berechtigungen
...
### <a name="create-an-emulator-with-google-apis"></a><a name="create-emulator-with-google-api"></a>Erstellen eines Emulators mit Google-APIs
...
### <a name="googlemap-properties"></a><a name="googlemap_object"></a>GoogleMap-Eigenschaften
