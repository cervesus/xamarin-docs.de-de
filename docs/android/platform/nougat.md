...
[![Hero Bilder von Android-Tablets und Telefone mit Android Nougat](nougat-images/android-n-hero-sml.png)](nougat-images/android-n-hero.png#lightbox)
...
3.  Installieren Sie die neueste Android SDK-Tools:
    ...
    [![Die neueste Android SDK-Tools auswählen im Android SDK Manager](nougat-images/preview-tools.png)](nougat-images/preview-tools.png#lightbox)
...
> [!NOTE]
> Derzeit müssen Sie festlegen, die **mindestens Android-Version** auf **Android 7.0 (24-API - Nougat)** zum Bereitstellen Ihrer app für Android Nougat Geräte oder Emulatoren.
...
[![Beispiel-apps, die im Modus mit mehreren Fenster Hochformat- und querformatausrichtung ausgeführt werden.](nougat-images/multi-window-mode.png)](nougat-images/multi-window-mode.png#lightbox)
...
[![Bildschirmabbildung von Beispiel gebündelte Benachrichtigungen](nougat-images/bundled-notifications-sml.png)](nougat-images/bundled-notifications.png#lightbox)
...
[![Seite "Beispiel" des ein app-Kontextmenü für eine messaging-app](nougat-images/app-shortcuts-sml.png)](nougat-images/app-shortcuts.png#lightbox)
