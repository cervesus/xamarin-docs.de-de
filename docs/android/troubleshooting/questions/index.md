...
### <a name="which-android-sdk-packages-should-i-installinstall-android-sdk-packagesmd"></a>[Welche Android SDK-Paketen sollte ich installiere?](install-android-sdk-packages.md)
...
### <a name="where-can-i-set-my-android-sdk-locationsandroid-sdk-locationmd"></a>[Wo kann ich mein Android SDK-Verzeichnissen festlegen?](android-sdk-location.md)
...
### <a name="how-do-i-update-the-java-development-kit-jdk-versionupdate-jdkmd"></a>[Wie aktualisieren kann ich die Java Development Kit (JDK) Version?](update-jdk.md)

In diesem Artikel wird veranschaulicht, wie die Java Development Kit (JDK) Version auf Windows- und Mac aktualisieren

### <a name="can-i-use-java-development-kit-jdk-version-9jdk9-errorsmd"></a>[Kann Java Development Kit (JDK) Version 9 werden verwendet?](jdk9-errors.md)
...
### <a name="how-can-i-manually-install-the-android-support-libraries-required-by-the-xamarinandroidsupport-packagesinstall-android-support-librarymd"></a>[Wie kann ich die Bibliotheken, Android, unterstützen von den Paketen Xamarin.Android.Support manuell installieren?](install-android-support-library.md)
...
### <a name="how-do-i-install-google-play-services-in-an-emulatorinstall-gpsmd"></a>[Wie installiere ich einen Emulator Google Play-Dienste?](install-gps.md)
...
### <a name="what-usb-drivers-do-i-need-to-debug-android-on-windowsandroid-drivers-debug-windowsmd"></a>[Welche USB-Treiber ist zum Debuggen von Android unter Windows erforderlich?](android-drivers-debug-windows.md)
...
### <a name="is-it-possible-to-connect-to-android-emulators-running-on-a-mac-from-a-windows-vmconnect-android-emulator-mac-windowsmd"></a>[Ist es möglich, mit der Android-Emulatoren Verbinden von Windows-VM auf einem Mac ausgeführt?](connect-android-emulator-mac-windows.md)

Dieser Leitfaden behandelt Methoden auf, wenn Sie einen Google Android-Emulator verwenden.

## <a name="general-questions"></a>Allgemeine Fragen

### <a name="how-do-i-automate-an-android-nunit-test-projectautomate-android-nunit-testmd"></a>[Wie wird automatisiert ein Testprojekt für Android NUnit?](automate-android-nunit-test.md)
...
### <a name="how-do-i-enable-intellisense-in-android-axml-filesenable-axml-intellisensemd"></a>[Wie aktiviere ich Intellisense in Android .axml-Dateien?](enable-axml-intellisense.md)

Dieses Handbuch beschreibt, wie Sie Visual Studio Intellisense für Android .axml Dateien zu aktivieren.

### <a name="why-cant-my-android-release-build-connect-to-the-internetandroid-internetmd"></a>[Warum herstellen kann nicht Mein Android Releasebuild mit dem Internet?](android-internet.md)
...
### <a name="smarter-xamarin-android-support-v4--v13-nuget-packagesandroid-support-v4v13-librariesmd"></a>[Intelligentere Xamarin Android unterstützt v4 / v13 NuGet-Pakete](android-support-v4v13-libraries.md)
...
> [!NOTE]
> **Hinweis:** die folgenden Artikeln auf Probleme, die in den neuesten Versionen von Xamarin aufgelöst wurden anwenden. Allerdings tritt das Problem auf die neueste Version der Software, bitte der Datei eine [neuen Fehler](~/cross-platform/troubleshooting/questions/howto-file-bug.md) mit Ihrer vollständigen versionsverwaltung-Informationen "und" vollständig "Ausgabeprotokoll erstellen.

### <a name="what-version-of-xamarinandroid-added-lollipop-supportxa-lollipopmd"></a>[Welche Version der Xamarin.Android Lollipop-Unterstützung hinzugefügt?](xa-lollipop.md)
...
### <a name="adjusting-java-memory-parameters-for-the-android-designerandroid-designer-java-memorymd"></a>[Anpassen der Java-Speicher-Parameter für den Android-designer](android-designer-java-memory.md)
...
### <a name="my-android-resourcedesignercs-file-will-not-updateresource-designer-wont-updatemd"></a>[Mein Android Resource.designer.cs-Datei wird nicht aktualisiert werden.](resource-designer-wont-update.md)
